...
mixin _$Collection {
 ...
 String get id; String get date; String get type; double get amount; User? get createdBy; String? get createdAt; String? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,date,type,amount,createdBy,createdAt,updatedAt);

@override
String toString() {
  return 'Collection(id: $id, date: $date, type: $type, amount: $amount, createdBy: $createdBy, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String date, String type, double amount, User? createdBy, String? createdAt, String? updatedAt
});
...
/// Create a copy of Collection
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? date = null,Object? type = null,Object? amount = null,Object? createdBy = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String date,  String type,  double amount,  User? createdBy,  String? createdAt,  String? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Collection() when $default != null:
return $default(_that.id,_that.date,_that.type,_that.amount,_that.createdBy,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String date,  String type,  double amount,  User? createdBy,  String? createdAt,  String? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Collection():
return $default(_that.id,_that.date,_that.type,_that.amount,_that.createdBy,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String date,  String type,  double amount,  User? createdBy,  String? createdAt,  String? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Collection() when $default != null:
return $default(_that.id,_that.date,_that.type,_that.amount,_that.createdBy,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _Collection implements Collection {
  const _Collection({required this.id, required this.date, required this.type, required this.amount, this.createdBy, this.createdAt, this.updatedAt});
...
/// Create a copy of Collection
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? date = null,Object? type = null,Object? amount = null,Object? createdBy = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
